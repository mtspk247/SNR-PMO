...
/** Managed-list (org_options) editor. Embedded in Settings → Lists & options. */
export default function ListsManager() {
  ...
  if (!admin) return <EmptyState icon="ti-lock" title="Admins only" text="Managing lists is restricted to workspace owners and admins." />;
      ...
      <div className="grid lg:grid-cols-[16rem_1fr] gap-4">
        <div className="card p-2 h-fit">
          ...
          <div className="border-t border-line mt-2 pt-2 px-1">
            ...
            <Link href="/users" className="block text-2xs text-accentstrong hover:underline py-1">Roles &amp; permissions (RBAC) →</Link>
