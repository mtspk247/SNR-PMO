      ...
      {loading ? <Spinner /> : (
        <>
          <div className="flex items-center justify-between gap-3 mb-4 flex-wrap">
            <div><h3 className="text-sm font-semibold text-content">Roles &amp; permissions</h3><p className="text-2xs text-muted">Reusable permission templates and module access for your team</p></div>
            <div className="flex items-center gap-2"><ViewControls prefs={prefs} views={VIEWS} groupOptions={GROUPS} /><button onClick={openNew} className="btn btn-primary"><Icon name="ti-plus" />New role</button></div>
          </div>
