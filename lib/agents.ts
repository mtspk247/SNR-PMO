...
export const STARTER_AGENTS: { name: string; domain: AgentDomainKey; autonomy: string; description: string; tools: string[] }[] = [
  ...
  { name: 'Content Assistant', domain: 'marketing', autonomy: 'approve_first', description: 'Your content teammate — drafts social posts into the Social composer, and analyzes your performance to recommend what to post next. Approve-first; drafts only (publishing stays a human step).', tools: ['draft_social_post', 'analyze_social_performance'] },
