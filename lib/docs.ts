...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: 'callout', icon: 'ti-user-shield', text: 'Chief of Staff (your always-on manager): a floating assistant in the bottom-left corner (for people with Manage agents). Ask it in plain English \u2014 \u201conboard Acme Corp\u201d, \u201ckick off project Apollo\u201d, \u201cwhat needs my attention?\u201d, or even \u201ccreate a support agent\u201d \u2014 and it does the setup and drafts the work for your approval. It acts with YOUR permissions (it can only see and do what your role allows), it delegates to the right domain agent, and every action it proposes still goes through the approve-first, preflighted queue. Nothing runs until you approve it. Free-form requests use your connected AI key; the ready-made workflows and agent-creation work with no key at all.' },
