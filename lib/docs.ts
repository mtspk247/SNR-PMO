...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: 'callout', icon: 'ti-bolt', text: 'Agents take real actions, not just drafts: create and assign tasks, draft onboarding checklists, post journal entries, categorize expenses, triage tickets and support replies, move deal stages, send approved SMS, create CRM contacts and deals, and scaffold a whole project with its starter tasks \u2014 each one proposed, approved with a click, audited, and one-click reversible.' },
