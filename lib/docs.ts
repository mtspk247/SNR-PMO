...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: 'callout', icon: 'ti-id-badge-2', text: 'Per-agent reports (Agents \u25b8 Activity & ROI): every agent has a complete individual record, just like a human teammate \u2014 work done (net of rollbacks), per-skill breakdown, reliability, estimated time saved and net value at your blended rate, runs, tokens and metered cost, and first/last activity. Click an agent to open its full profile page (/agents/<id>): what it suggested by category, its complete action history with every detail (the exact payload it proposed, result, what rollback restores, decision notes) and the per-action audit trail \u2014 plus CSV export of the whole team or one agent\u2019s history. Visible to agent managers and approvers.' },
