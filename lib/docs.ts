...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: 'callout', icon: 'ti-link', text: 'Another column type is Relationship \u2014 link each row to a record from another module (Projects, Clients, Deals, Contacts, Tasks or People). Add it from the same \u201c+\u201d \u25b8 Connect \u25b8 Relationship, choose the module, then pick the linked record inline in the cell. It shows the record\u2019s name and links to it.' },
