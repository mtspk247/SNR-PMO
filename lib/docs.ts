  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: 'steps', items: [
        ...
        { title: 'Watch, rename & download', body: 'Click any row to play the recording in the browser, download the .webm file, or delete it. Rename inline from the list. Use search, columns and CSV export like every other list.' }, { title: 'Edit before saving', body: 'After recording, click Edit to trim the start/end, speed it up into a timelapse (2×–8×), adjust brightness, crop to 16:9/4:3/square, and add a watermark — then save as video (WebM) or export an animated GIF. Editing happens right in your browser.' },
      ] },
      { kind: 'bullets', items: [
