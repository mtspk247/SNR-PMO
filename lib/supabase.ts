...
export interface Attendance {
  ...
  check_in_lat?: number | null; check_in_lng?: number | null; check_in_accuracy?: number | null; check_in_place?: string | null;
...
export interface TaskFieldDef {
  ...
  field_type: 'text' | 'textarea' | 'number' | 'currency' | 'progress' | 'rating' | 'date' | 'checkbox' | 'dropdown' | 'multiselect' | 'labels' | 'url' | 'email' | 'phone' | 'location' | 'percent' | 'duration' | 'ai' | 'relationship' | 'rollup' | 'formula';
