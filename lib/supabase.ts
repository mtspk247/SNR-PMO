...
export interface TaskFieldDef {
  ...
  field_type: 'text' | 'textarea' | 'number' | 'currency' | 'progress' | 'rating' | 'date' | 'checkbox' | 'dropdown' | 'multiselect' | 'labels' | 'url' | 'email' | 'phone' | 'location' | 'percent' | 'duration' | 'ai' | 'relationship' | 'rollup';
