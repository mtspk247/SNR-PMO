...
export default function JobsPage() {
  ...
  return (
    <Layout flat title="Jobs">
      ...
      <ListToolbar prefs={prefs} cols={COLS} filters={JOB_FILTERS} placeholder="Search jobs…">
